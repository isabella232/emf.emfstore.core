 ...
 * {@link org.eclipse.emf.emfstore.internal.server.model.versioning.ChangePackageProxy} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 *
 * @generated
...
public class ChangePackageProxyItemProvider extends ItemProviderAdapter
	 ...
	 * @generated
	 */
	public ChangePackageProxyItemProvider(AdapterFactory adapterFactory) {
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/ChangePackageProxy")); //$NON-NLS-1$
	}
	...
	public String getText(Object object) {
		final String label = ((ChangePackageProxy) object).getId();
		return label == null || label.length() == 0 ? getString("_UI_ChangePackageProxy_type") : //$NON-NLS-1$
			getString("_UI_ChangePackageProxy_type") + " " + label; //$NON-NLS-1$ //$NON-NLS-2$
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(ChangePackageProxy.class)) {
