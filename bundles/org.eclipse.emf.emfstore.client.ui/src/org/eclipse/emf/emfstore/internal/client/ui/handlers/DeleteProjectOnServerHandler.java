...
public class DeleteProjectOnServerHandler extends AbstractEMFStoreHandler {
	...
	@Override
	public void handle() {
		final ProjectInfo projectInfoSelection = requireSelection(ProjectInfo.class);
		final ServerInfo serverInfo = (ServerInfo) projectInfoSelection.eContainer();
		new UIDeleteRemoteProjectController(getShell(), serverInfo, projectInfoSelection).execute();
	}
}
