...
public class DefaultESOrgUnitResolverService implements ESOrgUnitResolver {
	 ...
	 * {@inheritDoc}
	 *
	 * @see org.eclipse.emf.emfstore.server.auth.ESOrgUnitResolver#resolve(org.eclipse.emf.emfstore.internal.server.model.SessionId)
	 */
	public ESUser resolveRoles(ESAuthenticationInformation authInfo) throws AccessControlException {
		final ESUser copyAndResolveUser = copyAndResolveUser(authInfo.getUser());
		return copyAndResolveUser;
	}
	 ...
	 *
	 * @see org.eclipse.emf.emfstore.server.auth.ESOrgUnitResolver#resolve(org.eclipse.emf.emfstore.server.model.ESOrgUnitId)
	 */
	public ESUser resolve(ESOrgUnitId orgUnitId) throws AccessControlException {
	 ...
	 * {@inheritDoc}
	 *
	 * @see org.eclipse.emf.emfstore.server.auth.ESOrgUnitResolver#getGroups(org.eclipse.emf.emfstore.server.model.ESUser)
	 */
