...
public class MutatorConfigImpl extends AbstractAPIDeletegateImpl<ESMutatorConfigImpl, MutatorConfig> implements
	 ...
	 * @ordered
	 */
	protected static final int MUTATION_COUNT_EDEFAULT = -1;
	 ...
	 * @ordered
	 */
	protected int mutationCount = MUTATION_COUNT_EDEFAULT;
	 ...
	 * @ordered
	 */
	protected static final boolean ALLOW_DUPLICATE_IDS_EDEFAULT = false;
	 ...
	 * @ordered
	 */
	protected boolean allowDuplicateIDs = ALLOW_DUPLICATE_IDS_EDEFAULT;
	...
	public void setMinObjectsCount(int newMinObjectsCount) {
		final int oldMinObjectsCount = minObjectsCount;
	...
	public void setIgnoreAndLog(boolean newIgnoreAndLog) {
		final boolean oldIgnoreAndLog = ignoreAndLog;
	...
	public void setDoNotGenerateRoot(boolean newDoNotGenerateRoot) {
		final boolean oldDoNotGenerateRoot = doNotGenerateRoot;
	...
	public void setUseEcoreUtilDelete(boolean newUseEcoreUtilDelete) {
		final boolean oldUseEcoreUtilDelete = useEcoreUtilDelete;
	...
	public void setMaxDeleteCount(Integer newMaxDeleteCount) {
		final Integer oldMaxDeleteCount = maxDeleteCount;
	...
	public void setMutationCount(int newMutationCount) {
		final int oldMutationCount = mutationCount;
		mutationCount = newMutationCount;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigPackage.MUTATOR_CONFIG__MUTATION_COUNT,
				oldMutationCount, mutationCount));
		}
	}
	...
	public void setAllowDuplicateIDs(boolean newAllowDuplicateIDs) {
		final boolean oldAllowDuplicateIDs = allowDuplicateIDs;
		allowDuplicateIDs = newAllowDuplicateIDs;
		if (eNotificationRequired()) {
			eNotify(new ENotificationImpl(this, Notification.SET, ConfigPackage.MUTATOR_CONFIG__ALLOW_DUPLICATE_IDS,
				oldAllowDuplicateIDs, allowDuplicateIDs));
		}
	}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case ConfigPackage.MUTATOR_CONFIG__MAX_DELETE_COUNT:
			...
			return;
		case ConfigPackage.MUTATOR_CONFIG__MUTATION_COUNT:
			setMutationCount((Integer) newValue);
			return;
		case ConfigPackage.MUTATOR_CONFIG__ALLOW_DUPLICATE_IDS:
			setAllowDuplicateIDs((Boolean) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		...
		case ConfigPackage.MUTATOR_CONFIG__MAX_DELETE_COUNT:
			...
			return;
		case ConfigPackage.MUTATOR_CONFIG__MUTATION_COUNT:
			setMutationCount(MUTATION_COUNT_EDEFAULT);
			return;
		case ConfigPackage.MUTATOR_CONFIG__ALLOW_DUPLICATE_IDS:
			setAllowDuplicateIDs(ALLOW_DUPLICATE_IDS_EDEFAULT);
			return;
		}
	...
	public boolean eIsSet(int featureID) {
		...
		case ConfigPackage.MUTATOR_CONFIG__ALLOW_DUPLICATE_IDS:
			return allowDuplicateIDs != ALLOW_DUPLICATE_IDS_EDEFAULT;
		}
	...
	public String toString() {
		...
		result.append(" (minObjectsCount: "); //$NON-NLS-1$
		result.append(minObjectsCount);
		result.append(", ignoreAndLog: "); //$NON-NLS-1$
		result.append(ignoreAndLog);
		result.append(", doNotGenerateRoot: "); //$NON-NLS-1$
		result.append(doNotGenerateRoot);
		result.append(", useEcoreUtilDelete: "); //$NON-NLS-1$
		result.append(useEcoreUtilDelete);
		result.append(", maxDeleteCount: "); //$NON-NLS-1$
		result.append(maxDeleteCount);
		result.append(", mutationCount: "); //$NON-NLS-1$
		result.append(mutationCount);
		result.append(", allowDuplicateIDs: "); //$NON-NLS-1$
		result.append(allowDuplicateIDs);
		result.append(')');
	...
	public ESMutatorConfigImpl createAPI() {
		return new ESMutatorConfigImpl(this);
	}
